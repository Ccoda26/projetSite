...
class ArticlesHelper extends PageController
{
    private $articles = [
        1=>  [
            "id" => 1,
    ...
    // method qui permet d'afficher tous mes articles
    public function getArticles(): array
    {
        return $this->articles;
    }

    // method pour obtenir les trois dernier articles ajouter
    public function lastArticle(){
        $articlestris = array_slice($this->articles, -3);
        return $articlestris;
    }
}